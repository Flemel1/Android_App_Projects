...
public class ActivityAddReminder extends AppCompatActivity implements
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(ActivityAddReminder.this);
                    return true;
                }
...
*/
        ...
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_TITLE, mTitle);
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_DATE, mDate);
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_TIME, mTime);
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_REPEAT, mRepeat);
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_REPEAT_NO, mRepeatNo);
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_REPEAT_TYPE, mRepeatType);
        values.put(AlarmReminderModel.AlarmReminderEntry.KEY_ACTIVE, mActive);
